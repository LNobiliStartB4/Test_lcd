...
const uint16_t BITMAP_PC_WAIT_DEVICE_ID = 6;
const uint16_t BITMAP_PILL_RED_ID = 7;
const uint16_t BITMAP_RFID_CONTACTLESS_ID = 8;
const uint16_t BITMAP_START_PLAY_ICON_WHITE_ID = 9;
const uint16_t BITMAP_START_STOP_ICON_WHITE_ID = 10;
