...
#define ST25R95_N_SS_PIN             RFID_CS_Pin
#define ST25R95_N_SS_PORT            RFID_CS_GPIO_Port

#define ST25R95_N_IRQ_OUT_PIN        RFID_IRQ_OUT_Pin
#define ST25R95_N_IRQ_OUT_PORT       RFID_IRQ_OUT_GPIO_Port
#define ST25R95_N_IRQ_IN_PIN         RFID_IRQ_IN_Pin
#define ST25R95_N_IRQ_IN_PORT        RFID_IRQ_IN_GPIO_Port


#define PLATFORM_LED_A_PIN           STATUS_LED_Pin
#define PLATFORM_LED_A_PORT          STATUS_LED_GPIO_Port
#define PLATFORM_LED_B_PIN           STATUS_LED_Pin
#define PLATFORM_LED_B_PORT          STATUS_LED_GPIO_Port
#define PLATFORM_LED_F_PIN           STATUS_LED_Pin
#define PLATFORM_LED_F_PORT          STATUS_LED_GPIO_Port
#define PLATFORM_LED_V_PIN           STATUS_LED_Pin
#define PLATFORM_LED_V_PORT          STATUS_LED_GPIO_Port
...
#define platformSpiSelect()                           ((void)SharedSpi2_Select(SHARED_SPI2_DEVICE_RFID, 50U))
#define platformSpiDeselect()                         SharedSpi2_Deselect(SHARED_SPI2_DEVICE_RFID)
#define platformSpiTxRx(txBuf, rxBuf, len)            SharedSpi2_TransmitReceive((txBuf), (rxBuf), (len), 1000U)
